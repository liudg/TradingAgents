...
基于 [market-scorecard-v2.2.md](/E:/document/TradingAgents/docs/market-scorecard-v2.2.md) 实现一套完整的市场监控系统，服务对象为美股 `Nasdaq 100 + 主要行业 ETF`。
...
- MA50、MA200
- 3 月区间高低点
- Nasdaq 100 成分股站上 MA200 占比
- 新高 / 新低简化统计

### 短线卡需要

- 行业 ETF 5d / 20d 动量
- Nasdaq 100 成分股突破后延续统计
- 回调低吸样本统计
- SPY ATR%
- SPY 隔夜缺口质量
